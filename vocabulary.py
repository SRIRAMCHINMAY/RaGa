...
total_midi_events=note_on_events+time_shift_events+velocity_events
...
def indices_to_event(index_list,_vocab=None):
    """convert index_list to list of events in vocab"""
    if _vocab is None:
        _vocab=vocab
    event_list=[]
